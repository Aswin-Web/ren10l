    ...
    <div>
      <div className="h-[10vh]  bg-lightBgColor border-lightBgColor flex flex-row justify-end items-center gap-4 mx-2 text-sm ">
        ...
        <div className="flex-2 flex flex-row justify-around items-center gap-4 mx-2 text-sm">
          <Link
            href={`/admin/services/property_rentals/${service_id}/dashboard`}
          >
          ...
          <Link
            href={`/admin/services/property_rentals/${service_id}/pending-customer`}
          >
            <button className="border-lightBgColor flex gap-1 items-center justify-center">
              <MdPending size={18} />
              Pending Customer
          ...
          <Link
            href={`/admin/services/property_rentals/${service_id}/all-customer`}
          >
            <button className="border-lightBgColor flex gap-1 items-center justify-center">
              <MdPeopleAlt size={18} />
              All Customer
          ...
          <Link href={`/admin/services/property_rentals/${service_id}/billing`}>
            <button className="border-lightBgColor flex gap-1 items-center justify-center">
          ...
          <Link
            href={`/admin/services/property_rentals/${service_id}/customize-space`}
          >
            <button className="border-lightBgColor flex gap-1 items-center justify-center">
